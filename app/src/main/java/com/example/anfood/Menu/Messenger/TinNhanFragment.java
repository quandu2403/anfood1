...
import com.example.anfood.Adapter.MessengerAdapter;
import com.example.anfood.Model.Messenger;
...
public ArrayList<Messenger> dsMess = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     // list chat
        ...
        Messenger user = new Messenger("ac","Trần Đỗ Minh Ân","Xin chào! Tôi cần giúp đỡ...","Trực tuyến");
        Messenger user2 = new Messenger("ac","Ngọc Trinh","Xin chào! Tôi cần giúp đỡ...","Đang bận");
        Messenger user3 = new Messenger("ac","Hải xồm","Xin chào! Tôi cần giúp đỡ...","Ngoại tuyến");
